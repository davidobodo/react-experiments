...
export default class CollectionExample extends React.PureComponent {
    ...
    render() {
        ...
        //         <ContentBoxParagraph>
        //             Renders scattered or non-linear data. Unlike <code>Grid</code>, which renders checkerboard data, <code>Collection</code> can render arbitrarily
        //             positioned- even overlapping- data.
        //         </ContentBoxParagraph>
        ...
        //             <LabeledInput label="Scroll to cell" name="onScrollToCell" placeholder="Index..." onChange={this._onScrollToCellChange} value={scrollToCell || ""} />
        //             <LabeledInput label="Height" name="height" onChange={this._onHeightChange} value={height} />
        //             <LabeledInput
        //                 label="Horizontal Overscan"
        //                 name="horizontalOverscanSize"
        ...
        //                 value={horizontalOverscanSize}
        //             />
        //             <LabeledInput label="Vertical Overscan" name="verticalOverscanSize" onChange={this._onVerticalOverscanSizeChange} value={verticalOverscanSize} />
        //         </InputRow>
